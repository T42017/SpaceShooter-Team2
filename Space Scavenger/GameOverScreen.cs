...
namespace Space_Scavenger
{
    public class GameOverScreen : DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.DrawString(_gameOverFont, "Enemies Defeated: " + _myGame.defeatedEnemies, new Vector2(Globals.ScreenWidth / 2f + textPosition.X, Globals.ScreenHeight / 2f - textPosition.Y + 100), Color.SteelBlue);
            _spriteBatch.End();
